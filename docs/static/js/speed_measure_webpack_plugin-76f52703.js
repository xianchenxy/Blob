import"./vue-126afe2a.js";import{o as u,c as i,S as t,a as e,a3 as n}from"./@vue-268a4df7.js";const x={},v=`<p>After we import and use <code>speed-measure-webpack-plugin</code> plugin, we build</p>
<pre><code class="language-js">const SpeedMeasurePlugin = require('speed-measure-webpack-plugin');
const smp = new SpeedMeasurePlugin();
module.exports = smp.wrap(webpackConfig);
</code></pre>
<p>an error occurred
<img src="image/speed_measure_webpack_plugin.png" alt="error img">
...
const vueLoaderPluginIndex = webpackConfig.plugins.findIndex(e => e.constructor.name === 'Plugin'); 
const vueLoaderPlugin = webpackConfig.plugins[vueLoaderPluginIndex];
`)],-1),w=e("p",null,[n("then got the object return by "),e("code",null,"speed-measure-webpack-plugin"),n(". Replace with origin object finally.")],-1),b=e("pre",null,[e("code",{class:"language-js","v-pre":"true"},`const SpeedMeasurePlugin = require('speed-measure-webpack-plugin');
const smp = new SpeedMeasurePlugin();
...
configToExport.plugins[vueLoaderPluginIndex] = vueLoaderPlugin;
module.exports = configToExport;
`)],-1),P=e("p",null,[n("try agin "),e("code",null,"npm run build"),n(". It works now.")],-1);function o(s,k){return u(),i(t,null,[c,p,l,r,a,g,d,m,w,b,P],64)}const h={render:o};h.__hmrId="/Users/xianchenxy/Documents/Blog/posts/post/speed_measure_webpack_plugin/speed_measure_webpack_plugin.md";const C=s=>({components:s,render:o});export{h as VueComponent,C as VueComponentWith,x as attributes,v as html};
